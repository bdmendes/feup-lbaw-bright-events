...
@section('content')
<form id="eventCE" action="{{ empty($event) ? route('createEvent') : route('editEvent', [$event->id]) }}" enctype="multipart/form-data" method="post" class="d-flex justify-content-start mb-0">
    @csrf
    ...
    <div id="form-content" class="h-100 col-6 p-4 gap-4 d-flex flex-column">
        ...
        <div class="event-form w-100 d-flex flex-column border rounded p-3 gap-3">
            ...
            <div class="">
                ...
                <div class="col-lg-6 col-12">
                    ...
                    <button type="button" class="btn btn-custom" onclick="addTag('selec', 'tagsDiv');">
                        Add
                    </button>
        ...
        <button type="submit"
                    class="btn btn-custom"> @if ($event ?? '') Edit @else Create @endif </button>
    </div>
