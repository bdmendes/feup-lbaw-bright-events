...
@section('content')
    <div class="d-flex row gap-4">
        ...
        <div class="mb-5 d-flex row">
            <div>
                Popularity
                <button class="btn btn-outline-light"><i class="bi bi-arrow-up" style="color: black;"></i></button>
                <button class="btn btn-outline-light"><i class="bi bi-arrow-down" style="color: black;"></i></button>
            </div>
            <div>
                Date
                <button class="btn btn-outline-light"><i class="bi bi-arrow-up" style="color: black;"></i></button>
    ...
    <div class="col">
        <h2>Browse Events</h2>
        @include('partials.events.cardlist', compact('events'))
