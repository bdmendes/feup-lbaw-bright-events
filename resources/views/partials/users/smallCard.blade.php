<a href="{{ $user ? route('profile', ['username' => $user->username]) : '' }}"
    class="small-card d-flex justify-content-start align-items-center gap-4 text-dark" style="text-decoration: none;">
