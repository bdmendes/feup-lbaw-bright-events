...
CREATE TABLE event {
    ...
    organizer INTEGER REFERENCES user ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE attendance {
    ...
    attendee INTEGER REFERENCES user ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE attendance_request {
    ...
    event INTEGER REFERENCES event ON DELETE CASCADE ON UPDATE CASCADE, 
    user INTEGER REFERENCES user ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE poll {
    id SERIAL PRIMARY KEY,
    event INTEGER REFERENCES event ON DELETE CASCADE ON UPDATE CASCADE NOT NULL,
    creator INTEGER REFERENCES user ON DELETE SET NULL ON UPDATE CASCADE,
    title TEXT NOT NULL,
...
CREATE TABLE notification {
    ...
    user INTEGER REFERENCES user ON DELETE CASCADE ON UPDATE CASCADE NOT NULL,
...
CREATE TABLE report {
    ...
    handled_by INTEGER REFERENCES user ON DELETE SET NULL ON UPDATE CASCADE, 
    reported_event INTEGER REFERENCES event ON DELETE CASCADE ON UPDATE CASCADE, 
    reported_user INTEGER REFERENCES user ON DELETE CASCADE ON UPDATE CASCADE,
