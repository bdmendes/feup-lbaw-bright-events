...
INSERT INTO EVENT VALUES 
	 ...
	 (102, 'Knee pain corrective exercise workshop' ,'If you or a loved one is experiencing hip or knee pain, you wont want to miss this special event. This is an interactive workshop where you will perform the exercises while sitting at your computer.', TO_TIMESTAMP('2021/12/09 00:00', 'YYYY/MM/DD/ HH24:MI'), False, False, 'Finished', null, 106, 102) ,
	 (103, 'Baking from Scratch 101' ,'Formerly known as Puff Pastry 101, weve shifted to include fun baking projects of all kinds! Bring a friend and join us on Instagram Live!', TO_TIMESTAMP('2021/12/18 00:00', 'YYYY/MM/DD/ HH24:MI'), False, False, 'Finished', null, 109, 103) ,
	 ...
	 (108, 'Doge Disco Party' ,'Our ultimate dream is to create a Doge-Powered Party Metaverse. A new Party Layer that will sit atop reality, allowing anyone, anywhere to instantly step into a parallel dimension alive with sound, light and positive vibes.', TO_TIMESTAMP('2021/12/01 00:00', 'YYYY/MM/DD/ HH24:MI'), True, False, 'Finished', null, 109, 108) ,
	 ...
	 (110, 'Black Singles Virtual Speed Dating' ,'Join the Filter Off free virtual speed dating event! This event is for all ages.', TO_TIMESTAMP('2021/12/17 00:00', 'YYYY/MM/DD/ HH24:MI'), True, False, 'Finished', null, 104, 110) ,
